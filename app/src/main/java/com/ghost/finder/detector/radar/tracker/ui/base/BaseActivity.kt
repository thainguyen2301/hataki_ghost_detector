...
import com.ghost.finder.detector.radar.tracker.ui.internet.ErrorConnectionHataki1Activity
...
abstract class BaseActivity<VM : BaseViewModel, VB : ViewBinding> : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        lifecycleScope.launch {
            NetworkManager.Companion.instance(this@BaseActivity).isConnected.collect { isConnected ->
                delay(500)
                if (!isConnected) {
                    ErrorConnectionHataki1Activity.Companion.open(this@BaseActivity)
                }
            }
        }
        onResumeImpl()
