package com.ghost.finder.detector.radar.tracker.ui.setting
...
import com.ghost.finder.detector.radar.tracker.ui.language.LanguageActivity
...
class SettingHataki1Activity : BaseActivity<SettingViewModel, ActivitySettingHataki1Binding>(),
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.item_language -> {
                LanguageActivity.Companion.open(this@SettingHataki1Activity, true)
            }
            ...
            R.id.item_privacy -> {
                PrivacyPolicyHataki1Activity.Companion.open(this@SettingHataki1Activity)
            }
        }
    }
